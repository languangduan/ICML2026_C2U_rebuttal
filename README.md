...
## S1: Sensitivity to K on arXiv (N = 1024, lambda = 2.0)

| K   | Ratio  | Hit@K ↑ | Ctrl ↓ | Cos ↑  | Exp. ↓   |
|-----|--------|---------|--------|--------|----------|
...
## S2: Sensitivity to N on arXiv (fixed ratio)

| N    | K  | Ratio | Hit@K ↑ | Ctrl ↓ | Cos ↑  |
|------|----|-------|---------|--------|--------|
...
## S3: Sensitivity to n_profile (N = 1024, K = 30, lambda = 2.0)

| n_profile | Hit@K ↑ | Ctrl ↓ | Cos ↑  | Exp. ↓   |
|-----------|---------|--------|--------|----------|
...
| Noise | Cos ↑  | Hit@K ↑ | Ctrl ↓ | Exp. ↓   |
|-------|--------|---------|--------|----------|
| 0.0   | 0.0292 | 0.114   | 0.0159 | -0.0784  |
| 0.1   | 0.0280 | 0.126   | 0.0158 | -0.0864  |
| 0.2   | 0.0286 | 0.182   | 0.0169 | -0.0908  |
| 0.5   | 0.0294 | 0.270   | 0.0226 | -0.0956  |
...
|-------------------|----------|---------------------|
| Active atoms/doc  | 82.8/1024| Sparse usage        |
...
| Control MRR@K          | 0.6642 | 0.0520 |
| Target Exp. on Others  | 0.038  | 0.000  |
...
| Backbone            | top_k | lambda* | Hit@K Drop ↑ | Control Delta ↓ | Exposure Delta ↓ | BTR/AFT ↑ |
|---------------------|-------|---------|--------------|-----------------|------------------|-----------|
| gte-base            | 5     | 0.25    | 0.858        | 0.6999          | -0.165           | 86.66     |
| gte-base            | 10    | 0.25    | 0.858        | 0.6999          | -0.165           | 91.46     |
| gte-base            | 20    | 0.25    | 0.858        | 0.6967          | -0.165           | 98.08     |
| gte-base            | 30    | 0.25    | 0.858        | 0.6947          | -0.165           | 101.85    |
| gte-base            | 50    | 0.25    | 0.858        | 0.6930          | -0.165           | 115.16    |
| bge-base-en-v1.5    | 5     | 0.5     | 0.718        | 0.4969          | -0.015           | 38.98     |
| bge-base-en-v1.5    | 10    | 0.5     | 0.718        | 0.4968          | about 0          | 40.50     |
| bge-base-en-v1.5    | 20    | 0.5     | 0.718        | 0.4955          | -0.019           | 40.87     |
| bge-base-en-v1.5    | 30    | 0.5     | 0.718        | 0.4968          | -0.012           | 40.30     |
| bge-base-en-v1.5    | 50    | 0.5     | 0.714        | 0.4961          | +0.013           | 40.61     |
| e5-base-v2          | 5     | 1.0     | 0.336        | 0.144           | +0.108           | 25.73     |
| e5-base-v2          | 10    | 1.0     | 0.336        | 0.144           | +0.132           | 26.84     |
| e5-base-v2          | 20    | 1.0     | 0.336        | 0.147           | +0.132           | 24.55     |
| e5-base-v2          | 30    | 1.0     | 0.336        | 0.149           | +0.132           | 24.79     |
| e5-base-v2          | 50    | 1.0     | 0.332        | 0.149           | +0.132           | 24.33     |

**Note.** `e5-base-v2` uses instruction-prefix encoding (`query:` / `passage:`), which may induce representation mismatch.

---

## S11: Cross-domain transfer

| Source | Target   | Hit@K Drop ↑ | Control Delta ↓ | Cos Drop ↑ | Exp. Delta ↓ |
|--------|----------|--------------|-----------------|------------|--------------|
...
| Stage              | Mean (ms) | Note                                                         |
|--------------------|-----------|--------------------------------------------------------------|
| Index Build        | 1047      | one-time offline; n_idx = 2100 docs                          |
